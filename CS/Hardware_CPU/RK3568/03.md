...
/ {
	...
	adc_keys_0: adc-keys-0 {
		...
		arr-down-key {
			label = "down";
			linux,code = <KEY_DOWN>;
			press-threshold-microvolt = <1280000>;
		};
	...
	// 	// Exit key, function as return , K16
	// 	exit-key {
	// 		label = "exit";
	// 		linux,code = <KEY_EXIT>;
	// 		press-threshold-microvolt = <900000>;
	...
	// 	// File key, function as read existed image or video, K15
	// 	file-key {
	// 		label = "file";
	// 		linux,code = <KEY_FILE>;
	// 		press-threshold-microvolt = <1280000>;
	...
	// 	// Trigger key, K17. Click capture image; press capture video
	// 	trigger-camera-key {
	// 		label = "trigger_camera";
...
&i2c2 {
	...
	ov13850: ov13850@10 {
		...
		pinctrl-names = "default";
		pinctrl-0 = <&cam_clkout0>, <&ov13850_default_pin>;
	...
	gc2155: gc2155@3c{
		...
		// pinctrl-0 = <&cif_clk>, <&cif_dvp_bus16>;
		// pinctrl-0 = <&cam_clkout0>, <&cif_dvp_bus16>;
		power-gpios = <&gpio3 RK_PA0 GPIO_ACTIVE_HIGH>;
		// reset-gpios = <&gpio2 RK_PA6 GPIO_ACTIVE_HIGH>;
		rockchip,camera-module-index = <1>;
		rockchip,camera-module-facing = "front";
		rockchip,camera-module-name = "default"; 
		rockchip,camera-module-lens-name = "default"; 
		// rockchip,dvp_mode = "BT601";
		// rockchip,default_rect= <768 288>;
...
&dsi1 {
	...
	dsi1_panel: panel@0 {
		...
		panel-init-sequence = [
			15 00 02 53 29
			39 00 03 51 FF 01
			39 00 07 80 00 68 68 0E 00 31
			39 00 08 81 03 40 00 29 00 05 00
			39 00 08 82 03 40 00 29 00 05 01
			15 00 02 25 00
			15 00 02 26 20
			39 00 03 2A 00 A0
			39 00 03 F0 AA 11
			15 00 02 C0 00
			39 00 09 C2 01 1D 01 1D 01 1D 01 1D
			39 00 03 F0 AA 12
			39 00 03 BF 37 A9
			39 00 03 FF 5A 80
			39 00 02 65 2F
			...
			15 00 02 F2 00
			15 00 02 65 17
			39 14 0E F9 5E 62 66 6A 6F 73 77 7B 7F 84 88 8C 90
			05 64 01 11
			05 14 01 29
			39 00 03 F0 AA 11
			15 00 02 C0 FF
		...
		// i.e. enable gpio, default to high
		// enable-gpios = <&gpio3 RK_PA5 GPIO_ACTIVE_HIGH>;
		// i.e. ctl gpio, default to high
		// reset-gpios = <&gpio0 RK_PC4 GPIO_ACTIVE_LOW>;

        display-timings {
			native-mode = <&panel_evf>;
            panel_evf: timings {
				hfront-porch    = <88>;
				hsync-len       = <44>;
                hback-porch     = <148>;
