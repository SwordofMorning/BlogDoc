...
# udp send, host为接收ip
gst-launch-1.0 v4l2src device=/dev/video5 ! video/x-raw, format=NV12, width=1920, height=1080, framerate=30/1 ! mpph264enc ! rtph264pay config-interval=-1 ! udpsink host=192.168.50.192 port=12345
