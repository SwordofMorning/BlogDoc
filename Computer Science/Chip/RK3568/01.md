...
# 设置红外crop
v4l2-ctl -d /dev/video5 --set-crop top=0,left=0,width=320,height=256
v4l2-ctl -d /dev/video5 --set-fmt-video=width=320,height=256,pixelformat=YUYV --stream-mmap=3 --stream-to=pic.yuv --stream-count=1
```
