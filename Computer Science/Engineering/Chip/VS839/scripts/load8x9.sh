...
get_sensor_clk()
{
	case $1 in
		...
		"sc230ai")	echo "27000000";;
		"bg1336")	echo "27000000";;
		*)	echo "37125000";;
	esac
}
...
insert_ko()
{
	...
	insmod /lib/modules/vs_mipi_rx.ko sensor_clk=$SNS_CLK
	...
	insmod /lib/modules/vs_infra.ko
	insmod /lib/modules/vs_rvs.ko
}
