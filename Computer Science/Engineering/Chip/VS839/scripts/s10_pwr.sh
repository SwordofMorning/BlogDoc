...
# S10_pwr.sh - Power management initialization script

case "$1" in
    start)
        echo "Starting power management..."

        #################### Part III: load8x9 ####################

        # BG1336 use 27Mhz, BG0651 not use this XCLK
        /etc/load8x9.sh -i -sensor0 bg1336

        sleep 1

        echo "S10_pwr: sleep for stabilizing..."
        ...
        # Encoder, RE08115MX
        devmem 0x0ce1c148 32 0x00087301

        echo "Power management started successfully"
        ;;
    stop)
        echo "Stopping power management..."
